"""Full-recording controlled diagonal-whitening session-0010 pursuit."""
...
OUTPUT = ROOT / "residuals/runs/dataset1_p1/unwhitened_continuous_0010_full"
PARAMS = {
    ...
    "max_peaks_per_round": 10000, "fit_batch_size": 1024,
    "localization_config_batch_size": 32, "template_time_batch": 4096,
    "n_scales": 9, "max_channel_normalized_rmse": 3.0, "save_waveforms": True,
