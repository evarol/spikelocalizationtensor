...
## Sessions
- [Initial-Threshold Spike Discovery](session-017-initial-threshold-spike-discovery.md) — ACTIVE: six 0017 full-recording experiments are running/queued (`16575057`, `16575275`, `16575400`), with complete plot array `16575437` held until summaries exist; review plots before interpretation.
